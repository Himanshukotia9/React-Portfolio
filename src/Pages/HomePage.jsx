        ...
        <div className=' flex flex-row justify-evenly items-center mt-auto'>
            <div className='w-full sm:w-3/4'>
                ...
                initial="hidden" animate="visible" id="btn-box" className='my-5'>
                    <a href="/Himanshu Kotia Resume.pdf" download="" id="btn" className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 transition-all'>Download CV</a>
